...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // For demo purposes, redirect to dashboard after form submission
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-80px)] py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            <div className="mx-auto h-12 w-12 rounded-md bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center text-white text-lg font-bold shadow-sm">
              Q
            </div>
